...
$string['modulename'] = 'icecream';
$string['modulenameplural'] = 'icecreams';
$string['modulename_help'] = 'icecream help';
$string['icecreamfieldset'] = 'Custom example fieldset';
$string['icecreamname'] = 'icecream name';
$string['icecreamname_help'] = 'This is the content of the help tooltip associated with the icecreamname field. Markdown syntax is supported.';
$string['icecream'] = 'icecream';
$string['pluginadministration'] = 'icecream Administration';
$string['pluginname'] = 'icecream Activity';
...
$string['clonefrom'] ='Clone From';
$string['cloneto'] ='Clone To';
$string['manualinput'] ='Manual Input';
$string['updatedsettings'] ='Updated Availability Settings';

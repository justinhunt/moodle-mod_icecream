 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class mod_icecream_base_report {
	...
	public function fetch_head(){
		...
		foreach($this->fields as $field){
			$head[]=get_string($field,MOD_ICECREAM_LANG);
		}
		return $head;
	}
...
*
*/
class mod_icecream_basic_report extends  mod_icecream_base_report {
	...
	public function fetch_formatted_heading(){
		...
		//$ec = $this->fetch_cache(MOD_ICECREAM_TABLE,$record->englishcentralid);
		return get_string('basicheading',MOD_ICECREAM_LANG);
	...
	public function process_raw_data($formdata){
		...
		$emptydata = array();
		$alldata = $DB->get_records(MOD_ICECREAM_TABLE,array());
		if($alldata){
